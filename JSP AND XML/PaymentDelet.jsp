...
<center>
<h5>Do you want to delete this details ? </h5>
	...
	<table>
		...
		<td><input type="text" class="form-control" name="crdHolderName" value="<%= crdHolderName %>"readonly></td>
	</tr>
	<tr>
		<td>Card Number</td>
		<td><input type="text" class="form-control" name="crdNumber" value="<%= crdNumber %>"readonly></td>
	</tr>
	<tr>
		<td>Card Exp. Month</td>
		<td><input type="text" class="form-control" name="crdExpMonth" value="<%= crdExpMonth %>"readonly></td>
	</tr>
	<tr>
		<td>Card Exp.Year</td>
		<td><input type="text" class="form-control" name="crdExpYear" value="<%= crdExpYear %>"readonly></td>
	</tr>
		<tr>
		<td>Payment Amount</td>
		<td><input type="text" class="form-control" name="amount" value="<%= amount %>"readonly></td>
	</tr>	
		<tr>
		<td>Payment Date</td>
	...
	<br>
	<input type="submit" class="btn btn-primary" name="submit" value="Delete Payment">
	</form>
</div>
</center>
